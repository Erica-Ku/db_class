...
INSERT INTO `수강신청` VALUES ('1610001','1601001','2016-03-02 00:00:00','2016','1'),('1610002','1601002','2016-03-01 00:00:00','2016','1'),('1810001','1801001','2018-03-02 00:00:00','2018','1'),('1810002','1801002','2018-03-02 00:00:00','2018','1'),('1810003','1804003','2018-03-01 00:00:00','2018','1'),('1820001','1801001','2018-08-28 00:00:00','2018','2'),('1820002','1601001','2018-08-29 00:00:00','2018','2'),('1820003','1801002','2018-08-25 00:00:00','2018','2'),('1820004','1601002','2018-08-26 00:00:00','2018','2'),('1820005','1804003','2018-08-27 00:00:00','2018','2'),('1820006','1804003','2023-03-06 00:00:00','2023','1');
...
INSERT INTO `학과` VALUES ('01','컴퓨터정보학과','022-200-3000'),('02','전자공학과','022-200-4000'),('03','전기공학과','022-200-5000'),('04','정보통신공학과','022-200-6000'),('06','사물인터넷학과','022-222-2222'),('07','국어교육과','022-200-7001'),('08','빅데이터보안학과','022-111-1111');
...
UPDATE 학과 SET 학과명 = my학과명, 전화번호 = my전화번호
	WHERE 학과번호 = my학과번호; 
ELSE 
	INSERT INTO 학과(학과번호, 학과명, 전화번호) 
	VALUES(my학과번호, my학과명, my전화번호);  
...
-- Dump completed on 2023-03-09 14:25:08
